...
var genres = new _genres2.default();
...
$(document).ready(init);
},{"./modules/city-form":17,"./modules/genres":19,"./modules/map":22,"./modules/navigation":24,"./router":27}],2:[function(require,module,exports){
"use strict";
...
},{"../../node_modules/jquery/dist/jquery.min":28}],6:[function(require,module,exports){
"use strict";
...
function createArrayFromFusionData(data, key, numOfItems, optionalProps) {
  ...
  var _loop = function _loop() {
    var obj = {};
    for (key in newData) {
      if (parseInt((0, _strings.getNumber)(key)) === x && newData[key] !== "" && newData[key] !== NaN && newData[key] !== "NaN") {
...
},{"./genres":8}],13:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
var genreIcons = exports.genreIcons = [{
  genre: {
    checkedState: "",
    isSelected: false,
    state: "off",
    genre: "avant_garde",
    similarGenres: "avant garde,avant garde jazz,avant garde metal",
    name: "Avant Garde"
  }
}, {
  genre: {
  ...
  genre: {
    ...
    state: "off",
    genre: "classical",
    similarGenres: "classical,classical pop,contemporary classical music,crossover classical,modern classical",
    name: "Classical"
  }
}, {
  genre: {
    ...
    state: "off",
    genre: "comedy",
    similarGenres: "comedy,comedy rock",
    name: "Comedy"
  }
}, {
  genre: {
    ...
    state: "off",
    genre: "country",
    similarGenres: "country rock,alternative country,country honky tonk,cowboy punk,classic country,modern country,hillbilly,rockabilly,bluegrass,country pop,outlaw country,pop country,progressive country,texas country",
    name: "Country"
  }
}, {
  genre: {
  ...
  genre: {
    ...
    state: "off",
    genre: "electronic",
    similarGenres: "electronic,electro,electro hip hop,electro house,electro rock,electro-funk,electro-industrial,electro jazz,experimental electronic,indie electronic",
    name: "Electronic"
  }
}, {
  genre: {
    ...
    state: "off",
    genre: "folk",
    similarGenres: "folk,acid folk,alternative folk,contemporary folk,country folk,electric folk,folk pop,folk revival,folk rock,folk pop,indie folk,neo folk,pop folk,psychedelic folk,stomp and holler,traditional folk,urban folk",
    name: "Folk"
  }
}, {
  genre: {
    ...
    state: "off",
    genre: "hip_hop",
    similarGenres: "hip hop,classic hip hop,rap,west coast hip hop,alternative hip hop,east coast hip hop,electro hip hop,experimental hip hop,independent hip hop,indie hip hop,jazz hip hop,old school hip hop,southern hip hop",
    name: "Hip Hop"
  }
}, {
  genre: {
  ...
  genre: {
    ...
    state: "off",
    genre: "indie",
    similarGenres: "indie rock,geek rock,lo fi,math rock,indie folk,indie hip hop,indie,indy",
    name: "Indie"
  }
}, {
  genre: {
    ...
    state: "off",
    genre: "jazz",
    similarGenres: "jazz,jazz blues,jazz funk,jazz fusion,jazz hip hop,jazz rock,jazz vocal,latin jazz,modern jazz,new orleans jazz,soul jazz,traditional jazz",
    name: "Jazz"
  }
}, {
  genre: {
    ...
    state: "off",
    genre: "kid_music",
    similarGenres: "children's music",
    name: "Kids"
  }
}, {
  genre: {
    ...
    state: "off",
    genre: "latin",
    similarGenres: "latin,latin jazz,jazz latino,latin alternative,latin folk,latin hip hop,latin pop,latin music,latin rap,latin rock,latin ska",
    name: "Latin"
  }
}, {
  genre: {
    ...
    state: "off",
    genre: "motown",
    similarGenres: "motown,classic motown,soul,memphis soul,old school soul,soul music,soul,rhythm and blues,rhythm & blues",
    name: "Motown"
  }
}, {
  genre: {
    ...
    state: "off",
    genre: "new_age",
    similarGenres: "new age,new age music",
    name: "New Age"
  }
}, {
  genre: {
    ...
    state: "off",
    genre: "pop",
    similarGenres: "pop 60s,pop 80s,pop ,acoustic pop,alternative pop,pop rock ,dance pop,folk pop,jangle pop,pop country,pop punk,pop rap,pop folk,psychedelic pop",
    name: "Pop"
  }
}, {
  genre: {
    ...
    state: "off",
    genre: "punk",
    similarGenres: "punk,punk rock,acoustic punk,art punk,anarcho punk,classic punk,cowpunk,dance-punk,cyberpunk,emo punk,folk punk,garage punk,hardcore punk,indie punk,old school punk,political punk,skate punk,street punk",
    name: "Punk"
  }
}, {
  genre: {
    ...
    state: "off",
    genre: "rock",
    similarGenres: "rock punk rock classic rock college rock dance rock electro rock folk rock garage rock jam band hard rock modern rock psychedelic stoner rock punk southern rock 80s rock 90s rock 70s rock 60s rock alternative rock acoustic rock acid rock",
    name: "Rock"
  }
}, {
  genre: {
    ...
    state: "off",
    genre: "soft_rock",
    similarGenres: "soft rock easy listening",
    name: "Soft Rock"
  }
}, {
  genre: {
    ...
    state: "off",
    genre: "world",
    similarGenres: "world,world music,world beat,world fusion",
    name: "World"
  }
}];
...
},{"../helpers/add-to-storage":3,"../helpers/create-dom":5,"../helpers/each-template":7,"../helpers/memoize":10,"../helpers/urls":12,"./create-playlist":18}],15:[function(require,module,exports){
"use strict";
...
},{"../helpers/add-to-storage":3,"../helpers/create-dom":5,"../helpers/each-template":7,"../helpers/if-template":9,"../helpers/memoize":10,"./artist":16,"./modal-create":23}],16:[function(require,module,exports){
"use strict";
...
var Artist = function () {
  ...
  _createClass(Artist, [{
    ...
    value: function fetchArtists(name) {
      ...
      var url = _app.baseUrl + "/" + route + "/" + name;
...
},{"../app":1,"../helpers/add-to-storage":3,"../helpers/create-dom":5,"../helpers/each-template":7,"../helpers/memoize":10,"../helpers/urls":12,"./create-playlist":18,"./related-artists":25}],17:[function(require,module,exports){
"use strict";
...
var ArtistForm = function () {
  ...
  _createClass(ArtistForm, [{
    key: "createCityFormDom",
    value: function createCityFormDom() {
      var _this = this;
...
},{"../helpers/add-to-storage":3,"../helpers/create-dom":5,"../router":27}],18:[function(require,module,exports){
"use strict";
...
var player = new _spotifyPlayer2.default();
...
},{"../helpers/create-dom":5,"../helpers/each-template":7,"../helpers/if-template":9,"../helpers/memoize":10,"./spotify-player":26}],19:[function(require,module,exports){
"use strict";
...
},{"../app":1,"../helpers/action":2,"../helpers/create-dom":5,"../helpers/each-template":7,"../icons/genre-icons":13}],20:[function(require,module,exports){
"use strict";
...
},{"../app":1,"../helpers/create-dom":5,"../helpers/memoize":10,"./modal-create":23}],21:[function(require,module,exports){
"use strict";
...
var Location = function () {
  ...
  _createClass(Location, [{
    ...
    value: function createCityTracksDOM(data) {
      ...
      var flattenedData = (0, _arrays.sortArrAsc)((0, _arrays.flattenArrayOfObjects)(data, "topTracks"), "popularity");
...
},{"../app":1,"../helpers/add-to-storage":3,"../helpers/arrays":4,"../helpers/create-dom":5,"../helpers/each-template":7,"../helpers/if-template":9,"../helpers/memoize":10,"../helpers/strings":11}],22:[function(require,module,exports){
"use strict";
...
exports.default = Map;
},{"../app":1,"../helpers/create-dom":5,"./geolocation":20,"./location":21}],23:[function(require,module,exports){
"use strict";
...
var _templateObject = _taggedTemplateLiteral(["<section id=\"modal\" class=\"artist-modal\">\n        <div class=\"modal-dialog\" role=\"document\">\n          <header class=\"modal-header\">\n            <h4 id=\"modal-headline\">\n              ", "\n            </h4>\n            <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n            <span aria-hidden=\"true\">\xD7</span>\n          </button>\n          </header>\n          <div id=\"modal-container\" class=\"modal-body\"></div>\n          <div class=\"modal-footer\" id=\"modal-footer\"></div>\n        </div>\n    </section>"], ["<section id=\"modal\" class=\"artist-modal\">\n        <div class=\"modal-dialog\" role=\"document\">\n          <header class=\"modal-header\">\n            <h4 id=\"modal-headline\">\n              ", "\n            </h4>\n            <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n            <span aria-hidden=\"true\">\xD7</span>\n          </button>\n          </header>\n          <div id=\"modal-container\" class=\"modal-body\"></div>\n          <div class=\"modal-footer\" id=\"modal-footer\"></div>\n        </div>\n    </section>"]),
    _templateObject2 = _taggedTemplateLiteral(["<button id=\"", "\">\n          <a href=\"#", "\">", "</a>\n        </button>\n       "], ["<button id=\"", "\">\n          <a href=\"#", "\">", "</a>\n        </button>\n       "]);
  ...
  _createClass(ModalCreate, [{
    ...
    value: function createButtons() {
      ...
      params.forEach(function (arg) {
        var dom = (0, _createDom.escapeTemplate)(_templateObject2, arg.id, arg.hash, arg.value);
...
},{"../helpers/create-dom":5}],24:[function(require,module,exports){
"use strict";
...
exports.default = Navigation;
},{"../app":1,"../helpers/action":2,"../helpers/create-dom":5,"../helpers/each-template":7,"../helpers/if-template":9}],25:[function(require,module,exports){
"use strict";
...
},{"../app":1,"../helpers/add-to-storage":3,"../helpers/create-dom":5,"../helpers/each-template":7,"../helpers/if-template":9,"../helpers/memoize":10,"../helpers/urls":12}],26:[function(require,module,exports){
"use strict";
...
},{"../helpers/create-dom":5}],27:[function(require,module,exports){
"use strict";
...
var Router = function () {
  ...
  _createClass(Router, [{
    ...
    value: function _createHashArgs(hash) {
      ...
      params = hashArr[2] && hashArr[2].indexOf(":") > -1 ? hashArr[2] : hashArr[3];
...
},{"./modules/albums":14,"./modules/artist":16,"./modules/artist-info":15,"./modules/location":21,"./modules/map":22,"./modules/related-artists":25}],28:[function(require,module,exports){
