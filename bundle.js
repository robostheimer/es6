...
$(document).ready(init);
},{"./helpers/add-to-storage":2,"./modules/artist":13,"./modules/artist-form":11,"./modules/geolocation":15,"./router":21}],2:[function(require,module,exports){
'use strict';
...
},{"../../node_modules/jquery/dist/jquery.min":22,"./each-template":5}],4:[function(require,module,exports){
'use strict';
...
function createArrayFromFusionData(data, key, numOfItems) {
  ...
  for (var x = 0; x < numOfItems; x++) {
    var obj = {};
    for (key in data[0]) {
      if (parseInt((0, _strings.getNumber)(key)) === x && data[0][key] !== '') {
        obj[(0, _strings.removeNumbers)(key)] = data[0][key];
      }
    }
...
},{"./deep-find":4,"./strings":8}],6:[function(require,module,exports){
'use strict';
  ...
  _createClass(Album, [{
    ...
    value: function fetchAllAlbums(artist_id, name) {
      ...
      if (artist_id) {
        ...
        (0, _addToStorage.addToStorage)('hash', '/albums/' + artist_id + '/' + name);
        return data;
      }
    }
  }, {
    ...
    value: function createAlbumsDOM(data, name) {
      ...
      if (data.data) {
        //fusion table data
        resolvedData = (0, _eachTemplate.createArrayFromFusionData)(data.data, 'related', 30);
      } else {
        //spotify data
        resolvedData = data.spotify;
      }

      var dom = (0, _createDom.escapeTemplate)(_templateObject2, name, (0, _eachTemplate.each)({
        data: resolvedData,
        tag: 'li',
...
},{"../helpers/add-to-storage":2,"../helpers/create-dom":3,"../helpers/each-template":5,"../helpers/memoize":7,"../helpers/urls":9,"./create-playlist":14}],11:[function(require,module,exports){
'use strict';
...
},{"../helpers/add-to-storage":2,"../helpers/create-dom":3,"../router":21}],12:[function(require,module,exports){
'use strict';
...
},{"../helpers/add-to-storage":2,"../helpers/create-dom":3,"../helpers/each-template":5,"../helpers/if-template":6,"../helpers/memoize":7,"./artist":13,"./modal-create":18}],13:[function(require,module,exports){
'use strict';
...
var Artist = function () {
  ...
  _createClass(Artist, [{
    ...
    value: function fetchArtists(name) {
      ...
      var selectedCols = '*';
      var matchType = 'CONTAINS IGNORING CASE';
      var sortBy = 'ORDER%20BY+spotifyPopularity+DESC';
    ...
    value: function fetchTopTracks(id) {
      ...
      var matchType = 'CONTAINS IGNORING CASE';
      var sortBy = '';
      var fusionId = '1kd1mthytuNgg6v1uzMRRfEfBkX8qzZ2loRgAfePE';
      var key = 'AIzaSyBBcCEirvYGEa2QoGas7w2uaWQweDF2pi0';
      var where = 'Sid';
      var whereQuery = id;
...
},{"../helpers/add-to-storage":2,"../helpers/create-dom":3,"../helpers/each-template":5,"../helpers/memoize":7,"../helpers/urls":9,"./create-playlist":14,"./related-artists":19}],14:[function(require,module,exports){
'use strict';
...
},{"../helpers/create-dom":3,"../helpers/each-template":5,"../helpers/if-template":6,"../helpers/memoize":7,"./spotify-player":20}],15:[function(require,module,exports){
'use strict';
...
},{"../helpers/add-to-storage":2,"../helpers/create-dom":3,"../helpers/each-template":5,"../helpers/memoize":7,"../modules/map":17,"./modal-create":18}],16:[function(require,module,exports){
'use strict';
  ...
  _createClass(Location, [{
    ...
    value: function fetchLocationArtists(lat_lng_ratio) {
      if (lat_lng_ratio) {
        ...
        var url = baseUrl + '+*+FROM+1g-yJYLrmTDGBDTPp1o2hFdBmFhC4z2pvjE0vlEXv+WHERE+Lat%20%3E=%20%27' + min_lat + '%27+And+Lat%20%3C=%20%27' + max_lat + '%27+And+Lng%3E=' + min_lng + '+And+Lng%3C=' + max_lng + '+ORDER%20BY+spotifyPopularity+DESC&key=AIzaSyBBcCEirvYGEa2QoGas7w2uaWQweDF2pi0';
    ...
    value: function fetchCityArtists(city) {
      ...
      var url = baseUrl + '+*+FROM+1g-yJYLrmTDGBDTPp1o2hFdBmFhC4z2pvjE0vlEXv+WHERE+City+CONTAINS%20IGNORING%20CASE%27' + city + '%27+ORDER%20BY+spotifyPopularity+DESC&key=AIzaSyBBcCEirvYGEa2QoGas7w2uaWQweDF2pi0';
...
},{"../helpers/add-to-storage":2,"../helpers/create-dom":3,"../helpers/each-template":5,"../helpers/if-template":6,"../helpers/memoize":7,"../helpers/urls":9,"./artist":13}],17:[function(require,module,exports){
'use strict';
...
exports.default = Map;
},{"../helpers/create-dom":3,"../helpers/if-template":6,"../helpers/memoize":7}],18:[function(require,module,exports){
'use strict';
...
},{"../helpers/create-dom":3,"../helpers/if-template":6,"../router":21}],19:[function(require,module,exports){
'use strict';
...
},{"../helpers/add-to-storage":2,"../helpers/create-dom":3,"../helpers/each-template":5,"../helpers/if-template":6,"../helpers/memoize":7,"../helpers/urls":9}],20:[function(require,module,exports){
'use strict';
...
},{"../helpers/create-dom":3}],21:[function(require,module,exports){
"use strict";
...
var Router = function () {
  ...
  _createClass(Router, [{
    ...
    value: function hashToData(route, id, name) {
      ...
      if (route.isSubRoute) {
        ...
        parentOptions = {
          ...
          parentClassProp: parentClassProp,
          name: name
        };
        ...
        return this._fetchData(parentOptions).then(function () {
          return _this._fetchData(options);
        });
      } else {
    ...
    value: function _fetchData(options) {
      ...
      return options.className[property](options.id, options.name).then(function (data) {
        if (!data.error) {
          if (options.name) {
...
},{"./modules/albums":10,"./modules/artist":13,"./modules/artist-info":12,"./modules/geolocation":15,"./modules/location":16,"./modules/related-artists":19}],22:[function(require,module,exports){
