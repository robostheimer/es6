            ...
            if (checkbox.genre.genre === item.getAttribute("id")) {
                ...
                if (icons[index].genre.genre === checkbox.genre.genre) {
                    ...
                    if (isOn) {
                        ...
                        toggledClasses = classesArr.filter(item => item.indexOf("on") === -1);
                        input.checked = false;
                    }
                    else {
                        ...
                        toggledClasses = classesArr.filter(item => item.indexOf("off") === -1);
                        input.checked = true;
                    }
...
function addToHash(checkbox) {
    ...
    const similarGenres = similarGenresSplitter
        ...
        .join("");
    const newHash = hash.indexOf("genres") > -1
